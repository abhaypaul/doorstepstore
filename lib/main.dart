...
// Future<void> _showNoInternet() async {
...
//               Text('Please connect to a network and try again.'),
//             ],
//           ),
//         ),
//         actions: <Widget>[
...
// }
  ...
  Widget build(BuildContext context) {
  // if(!connection)
  // {_showNoInternet(); return Container(color: Colors.white);}
   ...
   return Scaffold(
      ...
      body:  SafeArea(child: Stack(children: <Widget>[
        ...
        Center(child: SizedBox(height: 30, width: 30,
          ...
          ,)
//          if(isLoading) Center(child: SizedBox(height: 30, width: 30,
//              child: CircularProgressIndicator(
//              )))
        ],)
        )
...
//          WebView(
//            initialUrl: "https://doorstepestore.com/frontend/home/home",
